...
from accounts.views import register_view, activate_account, dashboard, edit_details, delete_user
...
urlpatterns = [
    ...
    path('password_reset_confirm/<uidb64>/<token>',PasswordResetConfirmView.as_view(template_name='accounts/user/password_reset_confirm.html',
                                                                                    success_url='password_reset_complete',
                                                                                    form_class=PwdResetConfirmForm),name='password_reset_confirm'),
    path('password_reset/password_reset_email_confirm',TemplateView.as_view(template_name='accounts/user/reset_status.html'),
    ...
    path('profile/delete_confirm/', TemplateView.as_view(template_name='accounts/user/delete_confirm.html'), name='delete_confirm'),
